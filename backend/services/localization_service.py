class LocalizationService:
    ...
    STRINGS = {
        'en': {
            ...
            'period_morning': 'Morning (6:00 AM – 12:00 PM)',
            'period_afternoon': 'Afternoon (12:00 PM – 6:00 PM)',
            'period_evening': 'Evening (6:00 PM – 12:00 AM)',
            'period_night': 'Night (12:00 AM – 6:00 AM)',
            ...
            'reply_confirm_cancel': 'Please reply *Confirm* or *Cancel*.',
            'reschedule_title': 'Reschedule Appointment',
            'reschedule_select': 'Select the appointment you want to modify:',
            'reschedule_confirm': 'You selected to reschedule appointment *{appt_id}*.\n\nLet\'s book a new slot first. When confirmed, your old appointment will be cancelled.',
            'no_appts_reschedule': 'No active appointments to reschedule.',
            ...
            'menu_header': 'How can I help you today?',
            'menu_book': 'Book Appointment',
            'menu_book_desc': 'Book a new appointment',
            'menu_check': 'Check Appointments',
            'menu_check_desc': 'View upcoming appointments',
            'menu_resched': 'Reschedule',
            'menu_resched_desc': 'Modify your current booking',
            'menu_services': 'Services',
            'menu_services_desc': 'Browse available services',
            'menu_voice': 'Voice Booking',
            'menu_voice_desc': 'Book via voice in your language',
            'menu_all_options': 'All Options',
            'menu_see_all': 'See all options',
        ...
        'hi': {
            ...
            'period_morning': 'सुबह (6:00 AM – 12:00 PM)',
            'period_afternoon': 'दोपहर (12:00 PM – 6:00 PM)',
            'period_evening': 'शाम (6:00 PM – 12:00 AM)',
            'period_night': 'रात (12:00 AM – 6:00 AM)',
            'select_period': 'समय अवधि चुनें:',
            ...
            'reply_confirm_cancel': 'कृपया *पक्का करें* या *रद्द करें* लिखें।',
            'reschedule_title': 'अपॉइंटमेंट रीशेड्यूल करें',
            'reschedule_select': 'जिस अपॉइंटमेंट को बदलना है उसे चुनें:',
            'reschedule_confirm': 'आपने अपॉइंटमेंट *{appt_id}* को रीशेड्यूल करने के लिए चुना है।\n\nपहले नया स्लॉट बुक करें। पुष्टि होने पर पुरानी अपॉइंटमेंट रद्द हो जाएगी।',
            'no_appts_reschedule': 'रीशेड्यूल करने के लिए कोई सक्रिय अपॉइंटमेंट नहीं।',
            'your_appointments': 'आपकी अपॉइंटमेंट',
            'upcoming_appointments': 'आपकी आने वाली अपॉइंटमेंट:',
            'no_upcoming': 'कोई आने वाली अपॉइंटमेंट नहीं मिली।',
            'menu_header': 'आज मैं आपकी कैसे मदद करूँ?',
            'menu_book': 'अपॉइंटमेंट बुक करें',
            'menu_book_desc': 'नया अपॉइंटमेंट बुक करें',
            'menu_check': 'अपॉइंटमेंट देखें',
            'menu_check_desc': 'आने वाले अपॉइंटमेंट देखें',
            'menu_resched': 'रीशेड्यूल',
            'menu_resched_desc': 'मौजूदा बुकिंग बदलें',
            'menu_services': 'सेवाएं',
            'menu_services_desc': 'उपलब्ध सेवाएं देखें',
            'menu_voice': 'वॉइस बुकिंग',
            'menu_voice_desc': 'अपनी भाषा में वॉइस से बुक करें',
            'menu_all_options': 'सभी विकल्प',
            'menu_see_all': 'सभी विकल्प देखें',
            'menu_more': 'और विकल्प',
        },
        'te': {
            ...
            'period_morning': 'ఉదయం (6:00 AM – 12:00 PM)',
            'period_afternoon': 'మధ్యాహ్నం (12:00 PM – 6:00 PM)',
            'period_evening': 'సాయంత్రం (6:00 PM – 12:00 AM)',
            'period_night': 'రాత్రి (12:00 AM – 6:00 AM)',
            'select_period': 'సమయ వ్యవధిని ఎంచుకోండి:',
            ...
            'reply_confirm_cancel': 'దయచేసి *ఖరారు చేయండి* లేదా *రద్దు చేయండి* అని రాయండి.',
            'reschedule_title': 'అపాయింట్‌మెంట్ రీషెడ్యూల్',
            'reschedule_select': 'మార్చాలనుకుంటున్న అపాయింట్‌మెంట్‌ని ఎంచుకోండి:',
            'reschedule_confirm': 'మీరు అపాయింట్‌మెంట్ *{appt_id}* ని రీషెడ్యూల్ చేయడానికి ఎంచుకున్నారు.\n\nముందుగా కొత్త స్లాట్ బుక్ చేయండి. నిర్ధారించిన తర్వాత పాత అపాయింట్‌మెంట్ రద్దు అవుతుంది.',
            'no_appts_reschedule': 'రీషెడ్యూల్ చేయడానికి సక్రియ అపాయింట్‌మెంట్లు లేవు.',
            'your_appointments': 'మీ అపాయింట్‌మెంట్లు',
            'upcoming_appointments': 'మీ రాబోయే అపాయింట్‌మెంట్లు:',
            'no_upcoming': 'రాబోయే అపాయింట్‌మెంట్లు కనుగొనబడలేదు.',
            'menu_header': 'నేను మీకు ఎలా సహాయం చేయగలను?',
            'menu_book': 'అపాయింట్‌మెంట్ బుక్',
            'menu_book_desc': 'కొత్త అపాయింట్‌మెంట్ బుక్ చేయండి',
            'menu_check': 'అపాయింట్‌మెంట్లు చూడండి',
            'menu_check_desc': 'రాబోయే అపాయింట్‌మెంట్లు చూడండి',
            'menu_resched': 'రీషెడ్యూల్',
            'menu_resched_desc': 'ప్రస్తుత బుకింగ్ మార్చండి',
            'menu_services': 'సర్వీసులు',
            'menu_services_desc': 'అందుబాటులో ఉన్న సర్వీసులు చూడండి',
            'menu_voice': 'వాయిస్ బుకింగ్',
            'menu_voice_desc': 'మీ భాషలో వాయిస్ ద్వారా బుక్ చేయండి',
            'menu_all_options': 'అన్ని ఎంపికలు',
            'menu_see_all': 'అన్ని ఎంపికలు చూడండి',
            'menu_more': 'మరిన్ని ఎంపికలు',
        },
        'kn': {
            ...
            'period_morning': 'ಬೆಳಿಗ್ಗೆ (6:00 AM – 12:00 PM)',
            'period_afternoon': 'ಮಧ್ಯಾಹ್ನ (12:00 PM – 6:00 PM)',
            'period_evening': 'ಸಂಜೆ (6:00 PM – 12:00 AM)',
            'period_night': 'ರಾತ್ರಿ (12:00 AM – 6:00 AM)',
            'select_period': 'ಸಮಯದ ಅವಧಿಯನ್ನು ಆಯ್ಕೆಮಾಡಿ:',
            ...
            'booking_cancelled': 'ಬುಕಿಂಗ್ ರದ್ದುಮಾಡಲಾಗಿದೆ.',
            'reply_confirm_cancel': 'ದಯವಿಟ್ಟು *ಖಚಿತಪಡಿಸಿ* ಅಥವಾ *ರದ್ದುಮಾಡಿ* ಎಂದು ಬರೆಯಿರಿ.',
            'reschedule_title': 'ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ಮರುನಿಗದಿ',
            'reschedule_select': 'ಮಾರ್ಪಡಿಸಬೇಕಾದ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ಆಯ್ಕೆಮಾಡಿ:',
            'reschedule_confirm': 'ನೀವು ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ *{appt_id}* ಅನ್ನು ಮರುನಿಗದಿ ಮಾಡಲು ಆಯ್ಕೆ ಮಾಡಿದ್ದೀರಿ.\n\nಮೊದಲು ಹೊಸ ಸ್ಲಾಟ್ ಬುಕ್ ಮಾಡಿ. ಖಚಿತಪಡಿಸಿದ ನಂತರ ಹಳೆಯ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ರದ್ದಾಗುತ್ತದೆ.',
            'no_appts_reschedule': 'ಮರುನಿಗದಿ ಮಾಡಲು ಸಕ್ರಿಯ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್‌ಗಳಿಲ್ಲ.',
            'your_appointments': 'ನಿಮ್ಮ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್‌ಗಳು',
            'upcoming_appointments': 'ನಿಮ್ಮ ಮುಂಬರುವ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್‌ಗಳು:',
            'no_upcoming': 'ಮುಂಬರುವ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್‌ಗಳು ಕಂಡುಬಂದಿಲ್ಲ.',
            'menu_header': 'ಇಂದು ನಾನು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಲಿ?',
            'menu_book': 'ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ಬುಕ್',
            'menu_book_desc': 'ಹೊಸ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ಬುಕ್ ಮಾಡಿ',
            'menu_check': 'ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ನೋಡಿ',
            'menu_check_desc': 'ಮುಂಬರುವ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ನೋಡಿ',
            'menu_resched': 'ಮರುನಿಗದಿ',
            'menu_resched_desc': 'ಪ್ರಸ್ತುತ ಬುಕಿಂಗ್ ಬದಲಿಸಿ',
            'menu_services': 'ಸೇವೆಗಳು',
            'menu_services_desc': 'ಲಭ್ಯವಿರುವ ಸೇವೆಗಳನ್ನು ನೋಡಿ',
            'menu_voice': 'ಧ್ವನಿ ಬುಕಿಂಗ್',
            'menu_voice_desc': 'ನಿಮ್ಮ ಭಾಷೆಯಲ್ಲಿ ಧ್ವನಿ ಮೂಲಕ ಬುಕ್ ಮಾಡಿ',
            'menu_all_options': 'ಎಲ್ಲಾ ಆಯ್ಕೆಗಳು',
            'menu_see_all': 'ಎಲ್ಲಾ ಆಯ್ಕೆಗಳನ್ನು ನೋಡಿ',
            'menu_more': 'ಇನ್ನಷ್ಟು ಆಯ್ಕೆಗಳು',
        },
        'ta': {
            ...
            'period_morning': 'காலை (6:00 AM – 12:00 PM)',
            'period_afternoon': 'மதியம் (12:00 PM – 6:00 PM)',
            'period_evening': 'மாலை (6:00 PM – 12:00 AM)',
            'period_night': 'இரவு (12:00 AM – 6:00 AM)',
            'select_period': 'நேர காலத்தை தேர்ந்தெடுக்கவும்:',
            ...
            'reply_confirm_cancel': 'தயவுசெய்து *உறுதிப்படுத்துக* அல்லது *ரத்து செய்* என்று எழுதவும்.',
            'reschedule_title': 'அப்பாயிண்ட்மென்ட் மறுதிட்டம்',
            'reschedule_select': 'மாற்ற விரும்பும் அப்பாயிண்ட்மென்ட்டை தேர்ந்தெடுக்கவும்:',
            'reschedule_confirm': 'நீங்கள் அப்பாயிண்ட்மென்ட் *{appt_id}* ஐ மறுதிட்டமிட தேர்ந்தெடுத்துள்ளீர்கள்.\n\nமுதலில் புதிய ஸ்லாட் பதிவு செய்யவும். உறுதிப்படுத்தியவுடன் பழைய அப்பாயிண்ட்மென்ட் ரத்தாகும்.',
            'no_appts_reschedule': 'மறுதிட்டமிட செயலில் உள்ள அப்பாயிண்ட்மென்ட்கள் இல்லை.',
            'your_appointments': 'உங்கள் அப்பாயிண்ட்மென்ட்கள்',
            'upcoming_appointments': 'உங்கள் வரவிருக்கும் அப்பாயிண்ட்மென்ட்கள்:',
            'no_upcoming': 'வரவிருக்கும் அப்பாயிண்ட்மென்ட்கள் இல்லை.',
            'menu_header': 'இன்று நான் எப்படி உதவலாம்?',
            'menu_book': 'அப்பாயிண்ட்மென்ட் பதிவு',
            'menu_book_desc': 'புதிய அப்பாயிண்ட்மென்ட் பதிவு',
            'menu_check': 'அப்பாயிண்ட்மென்ட் பார்க்க',
            'menu_check_desc': 'வரவிருக்கும் அப்பாயிண்ட்மென்ட் பார்க்க',
            'menu_resched': 'மறுதிட்டம்',
            'menu_resched_desc': 'தற்போதைய பதிவை மாற்று',
            'menu_services': 'சேவைகள்',
            'menu_services_desc': 'கிடைக்கும் சேவைகளை பார்க்க',
            'menu_voice': 'குரல் பதிவு',
            'menu_voice_desc': 'உங்கள் மொழியில் குரல் மூலம் பதிவு',
            'menu_all_options': 'அனைத்து விருப்பங்கள்',
            'menu_see_all': 'அனைத்தையும் காண்க',
            'menu_more': 'மேலும் விருப்பங்கள்',
        }
    }
